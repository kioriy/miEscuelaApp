      ...
      <div class="max-w-4xl mx-auto w-full">
        ...
        <div class="bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden mb-6">
              ...
              <div class="md:col-span-8 flex flex-col gap-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <input type="text" v-model="form.name" class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-100 focus:border-blue-500 outline-none transition-all text-gray-700 bg-white shadow-sm" placeholder="Ej. Instituto Americano de Occidente">
                  </div>
                </div>
          ...
          <div class="px-8 py-5 bg-gray-50/80 border-t border-gray-100 flex items-center justify-end gap-4">
             <button type="button" @click="$router.push('/admin/schools')" class="px-5 py-2.5 rounded-xl font-semibold text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-200/50 transition-colors">
               Cancelar
             </button>
             <button type="button" class="px-7 py-2.5 rounded-xl font-bold text-sm text-white bg-blue-600 hover:bg-blue-700 shadow-sm shadow-blue-600/20 transition-all active:scale-[0.98]">
               Guardar Escuela
             </button>
          </div>
...
const dummyKiosks = ref(['K-7742', 'K-9901']);
